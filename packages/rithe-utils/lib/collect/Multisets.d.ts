...
declare function sum<T>(multiset1: Multiset<T>, multiset2: Multiset<T>): Multiset<T>;
declare function removeOccurrences<T>(multiset1: Multiset<T>, multiset2: Multiset<T>): Multiset<T>;
...
declare const _default: {
    ...
    sum: typeof sum;
    removeOccurrences: typeof removeOccurrences;
...
//# sourceMappingURL=Multisets.d.ts.map