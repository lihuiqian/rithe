...
declare function scan<T, R>(iterable: Iterable<T>, accumulator: (acc: R, value: T, index: number) => R, initial: R): Iterable<T>;
...
declare function equals<T>(iterable1: Iterable<T>, iterable2: Iterable<T>): boolean;
